...
0. Read `AGENTS.md` and load any applicable repository skills before other work.
...
4. After implementation, run the relevant tests and checks; use `harness-local-server` and `harness-playwright-evidence` when applicable.
